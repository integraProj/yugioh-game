...
public class Player implements Duelist {
	...
	public void takeDamage(int damage){
		...
		Logger.startLogs().info("Player - takeDamage Damage: " + damage );

		int lp = getLifePoints();
		setLifePoints(lp - damage);

		Logger.startLogs().info("Player - takeDamage Lifepoints: " + getLifePoints() );
	...
	private void playDamageSong(){
		...
		Logger.startLogs().info("Player - playDamageSong");
		...
		try{
			...
			Logger.startLogs().error("Player - Exception: " + e + " " + musicPath.getName() );		}
	}
